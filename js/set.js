...
let bg_img_preinstall = {
    ...
    "5": "https://v.api.aa1.cn/api/api-gqsh/index.php?wpon=s3s398eu7y6dt7e24", // 随机手绘
    "6": "https://v.api.aa1.cn/api/api-fj/index.php?aa1=suf7y58th48u935" // 随机视频
};
...
function setBgImgInit() {
    ...
    switch (bg_img["type"]) {
        ...
        case "4":
            ...
            break;
        case "5":
            $('#bg').attr('src', `./img/background${1 + ~~(Math.random() * 10)}.webp`); //随机手绘
            break;
        case "6":
            $('#bg').attr('src', bg_img_preinstall[6]); //随机视频
            break;
    }
}
