...
const add_id = "dmmgmugkonoqhxze"; // app_id
const app_secret = "QTR3dEhBejMybElxWE5aK1c1bG1WUT09"; // app_secret
const key = "7b8222698d6c4f238184b4d9e3940dc9" // key
function getWeather() {
    fetch("https://www.mxnzp.com/api/ip/self?app_id=dmmgmugkonoqhxze&app_secret=QTR3dEhBejMybElxWE5aK1c1bG1WUT09")
        .then(response => response.json())
        .then(data => {
